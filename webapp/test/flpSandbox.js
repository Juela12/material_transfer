		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#materialtransfermaterialtransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"materialtransfermaterialtransfer-display": {
								"semanticObject": "materialtransfermaterialtransfer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=materialtransfer.materialtransfer",
									"url": sap.ui.require.toUrl("materialtransfer/materialtransfer")
								}
							}
						}
					}
